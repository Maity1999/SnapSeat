    ...
    await sendEmail({
        ...
        body:`<div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
                ...
                <p>
                    ...
                    <strong>Seats:</strong>  ${booking.bookedSeats?.join(', ') || 'N/A'}
...
// inngest function to send reminder email to user 8 hour before the show
const reminderEmail=inngest.createFunction(
    {id:'reminder-email'},
    {cron:'0 */8 * * *'},//after every 8 hours
    async ({step})=>{
        const now=new Date();
        const in8Hours=new Date(now.getTime()+8*60*60*1000);
        const windowStart=new Date(in8Hours.getTime()-15*60*1000);
            ...
            return await Promise.allSettled(
                reminderTasks.map(task=> sendEmail({
                    ...
                    body:`<div style="font-family: Arial, sans-serif; padding: 20px;">
                            ...
                            <br/>
                            <p>Enjoy the show!<br/>SnapSeat Team</p>
                        </div>`
                }))
            )
        })
