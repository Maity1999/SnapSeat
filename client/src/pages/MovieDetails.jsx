...
import {timeFormat,dateFormat} from '../lib/dateTime';
    ...
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        ...
        <div className='relative flex flex-col gap-3'>
          ...
          <h1 className='text-xl font-semibold max-w-96 text-balance'>{show.movie.title}</h1>
          ...
          <p className='text-sm text-grey-400 mt-2'>
            {timeFormat(show.movie.runtime)} . {show.movie.genres.map(genre => genre.name).join(" | ")} . {dateFormat(show.movie.release_date)}
          </p>
